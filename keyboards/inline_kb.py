...
# Клавиатура для перехода к следующему вопросу
...
def create_question_kb(question_num: int):
    if question_num == 1:
        ...
        return InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="1) Бежать 🏃‍♂️", callback_data="q3_1")],
            [InlineKeyboardButton(text="2) Переходить дорогу 🚶‍♂️", callback_data="q3_2")],
        ...
        return InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="1) 8,92 килограмма ⚖️", callback_data="q5_1")],
        ...
        return InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="2) цифра 8 ♾️", callback_data="q7_2")],
        ...
        return InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="1) Февраль ❄️", callback_data="q10_1")],
